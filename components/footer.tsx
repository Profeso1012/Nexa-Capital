    ...
    <footer className="bg-muted py-12 border-t">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-light">Capital</span>
            </Link>
            <p className="text-muted-foreground mb-4">Securing Wealth. One Day at a Time.</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">123 Financial District, London, UK</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">info@nexacapital.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t mt-12 pt-8 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Nexa Capital Limited. All rights reserved.</p>
